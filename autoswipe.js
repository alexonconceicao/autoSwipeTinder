// ==UserScript==
// @name         Auto Like/Dislike for Tinder
...
(function () {
  ...
  let interval = 2000; // Intervalo entre ações (ms)
  ...
  async function autoAction() {
    ...
    if (profileButton) {
      ...
      await new Promise((resolve) => setTimeout(resolve, profileOpenWait / 2)); // Esperar o perfil carregar
